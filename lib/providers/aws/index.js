...
const getImage = require("get-ami");
...
const { setupIAMRole, setupKeyPair, setupVPC, cleanUp, cleanUpKeyPair, createEC2Object, createIAMObject, getUserName, getGroupName } = require("./internal.js");
...
async function awsCreate(argOrder) {
  ...
  //create KeyPair, IAM Role and VPC
    ...
    const [SubnetId, securityGroupId] = remaining.hasOwnProperty("SubnetId") && remaining.hasOwnProperty("SecurityGroupIds") ? [remaining.SubnetId, remaining.SecurityGroupIds] : await setupVPC(ec2, clusterID);
