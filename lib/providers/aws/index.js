...
const { waitForWrapper, setupIAMRole, setupKeyPair, getVPCSetting, cleanUp, cleanUpKeyPair, createEC2Object, createIAMObject, getUserName, getGroupName } = require("./internal.js");
...
async function awsCreate(argOrder) {
  ...
  //get ami id
  const image = await getImage(commonOpt.os, region, accessKeyId, secretAccessKey);
  ...
  //create KeyPair, IAM Role and VPC
    ...
    const [SubnetId, securityGroupId] = await getVPCSetting(remaining, ec2, clusterID);
